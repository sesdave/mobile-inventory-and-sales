...
public class Product {
	...
	private String vaPrice="Variable";
	 ...
	 */
	public Product(int id, String name, String barcode, double salePrice,String image) {
		this.id = id;
		this.name = name;
	 ...
	 * @param salePrice price for using when doing sale.
	 */
	public Product(String name, String barcode, double salePrice,String image) {
		this(UNDEFINED_ID, name, barcode, salePrice,image);
	}
