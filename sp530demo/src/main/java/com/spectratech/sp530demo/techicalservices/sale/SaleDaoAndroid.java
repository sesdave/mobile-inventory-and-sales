package com.spectratech.sp530demo.techicalservices.sale;
...
import com.spectratech.sp530demo.domain.sale.QuickLoadSale;
import com.spectratech.sp530demo.domain.sale.Sale;
import com.spectratech.sp530demo.techicalservices.Database;
import com.spectratech.sp530demo.techicalservices.DatabaseContents;
	...
	public List<LineItem> getLineItem(int saleId) {
		...
		for (Object object: objectList) {
			...
			for (Object object2: objectList2) {
				...
				productList.add(new Product(productId, content2.getAsString("name"), content2.getAsString("barcode"), content2.getAsDouble("unit_price"), content2.getAsString("image")));
			}
			list.add(new LineItem(productList.get(0), content.getAsInteger("quantity"),content.getAsDouble("unit_price"), content.getAsString("varname")));
		}
		return list;
	}
