package com.spectratech.sp530demo.techicalservices.inventory;

import android.content.ContentValues;
import android.util.Log;

import com.spectratech.sp530demo.domain.inventory.Product;
import com.spectratech.sp530demo.domain.inventory.ProductLot;
...
public class InventoryDaoAndroid implements InventoryDao {
	...
	public boolean editProduct(Product product) {
        ...
        content.put("status", "ACTIVE");
        content.put("unit_price", product.getUnitPrice());
		content.put("image", product.getUnitPrice());
	...
	public void suspendProduct(Product product) {
		...
		content.put("unit_price", product.getUnitPrice());
		content.put("unit_price", product.getImage());
