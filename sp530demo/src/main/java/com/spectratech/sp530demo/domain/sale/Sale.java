...
public class Sale {
	 ...
	 */
	public LineItem addLineItem(String varname,Product product, int quantity) {
		...
		LineItem lineItem = new LineItem(product, quantity,varname);
		items.add(lineItem);
		return lineItem;
	}

	public LineItem addLineItem(String varname,Product product, int quantity,double varprice) {


		LineItem lineItem = new LineItem(product, quantity,varprice,varname);
		items.add(lineItem);
		return lineItem;
	}
	public LineItem addLineItem(String varname, int quantity,double varprice) {


		LineItem lineItem = new LineItem(quantity,varprice,varname);
		items.add(lineItem);
		return lineItem;
	}
	...
	public int getQuantity() {
		int quant = 0;
		for(LineItem lineItem : items) {
			quant += lineItem.getTotalQuantity();
		}
		return quant;
	}
