...
public class AddItems extends AppCompatActivity {
    ...
    private static final String LOG_TAG = AddItems.class.getCanonicalName();
   ...
   /* private void clearAllBox() {
                ...
                DialogInterface.OnClickListener discardButtonClickListener =
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                NavUtils.navigateUpFromSameTask(AddItems.this);
                            }
                        };
    ...
    private boolean addItemToDb() {
        ...
        boolean success = productCatalog.addProduct(nameEdit
                    .getText().toString(), supplierNameEdit.getText()
                    .toString(), Double.parseDouble(priceEdit.getText()
                    .toString()),actualUri.toString());
            ...
            if (success) {
                Toast.makeText(this,
                        ...
                        Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddItems.this, ItemPage.class));
